...
Shader "TUT/PixelatedPopupMask02" {
	Properties {
	...
	SubShader {
		...
		struct v2f {
			...
			half2 uvORI: TEXCOORD0;//original
		};
		...
		fixed4 frag(v2f i) : SV_Target {					
					...
					fixed2 dir=fixed2(1,1);
					dir.x=1-step(fmod(indexXY.x,2),0.1)*2;
					dir.y=1-step(fmod(indexXY.y,2),0.1)*2;
